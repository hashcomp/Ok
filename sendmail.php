...
<link rel="shortcut icon" href="favicon.ico" type="image/x-icon"/>
  ...
  <style>
    ...
    ul {
      ...
      padding: 0;
      overflow: hidden;
      background-image: url("IMG_7408.JPG"); /* set your preferred image URL */
...
<ul>
  <div id="top-bar">
    <a href="index.php"><img width="230.25" height="63.4" src="mail.png" alt="friendnet."></a>
    <a href="menu.php">&#9776;</a>
    <a href="sendmail.php">&#8635;</a>
  </div>
</ul>
  <iframe id="content" src="mail.php"></iframe>
</body>
</html>
