...
<body>
    ...
    $profile_CSS = isset($matches_CSS[1]) ? $matches_CSS[1] : '';
...
<br><br>
  <a href="send.php?address=<?php echo $username ?>@friendnet">Send <?php echo $username ?> a message</a><br><br>
    <a href="add_friends.php?username=<?php echo $username ?>">Add Friends</a><br><br>
    <a href="friends.php?username=<?php echo $username ?>">View Friends</a><br><br>
</body>
</html>
